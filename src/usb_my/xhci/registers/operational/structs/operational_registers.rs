...
use crate::usb_my::xhci::registers::operational::structs::dcbaap::Dcbaap;
use crate::usb_my::xhci::registers::operational::structs::device_notification_control::DeviceNotificationControlRegister;
use crate::usb_my::xhci::registers::operational::structs::page_size::PageSizeRegister;
...
pub fn should_reset_xhc() {
    ...
    let mut op = crate::usb_my::xhci::registers::create_type::RegisterCreate::UncheckTransmute
        .new_operations(
