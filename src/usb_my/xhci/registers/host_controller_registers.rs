...
use crate::usb_my::xhci::registers::runtime::create::create_runtime_registers::ICreateRuntimeRegisters;
use crate::usb_my::xhci::registers::runtime::structs::runtime_registers::RuntimeRegisters;
...
impl HostControllerRegisters {
    pub fn new(create: RegisterCreate, mmio_base: u64) -> CommonResult<Self> {
        ...
        let operations = create.new_operations(mmio_base, capabilities.cap_length.read())?;
