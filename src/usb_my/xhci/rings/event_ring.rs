...
use crate::usb_my::xhci::registers::runtime::structs::interrupter::interrupter_registers::InterrupterRegisterSet;
...
use crate::usb_my::xhci::rings::event_ring_segment_table_entry::EventRingSegmentTableEntry;
use crate::usb_my::xhci::trb::trb_base::TrbBase;
